...
namespace COMP003A.LectureActivity5
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Multipication: {Multiply(inputNumber1, inputNumber2)}");
         ...
         * <summary></summary>used to describe a type number
        ...
        /// <param name="num1">Decimal input</param>
        /// <param name="num2">Decimal input</param>
        /// <returns>Reaminder after dividing two decimal inputs</returns>
